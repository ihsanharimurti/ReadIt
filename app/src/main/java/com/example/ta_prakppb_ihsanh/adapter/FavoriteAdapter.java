...
public class FavoriteAdapter extends RecyclerView.Adapter<FavoriteAdapter.ViewHolder> {
    ...
    public FavoriteAdapter(List<DataVolumeInfo> dataBuku, List<DataImageLinks> dataGambar, Context mContext) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            imgBook = itemView.findViewById(R.id.img_fav_books);
            tvTitle = itemView.findViewById(R.id.tv_judul_fav);
            tvAuthor = itemView.findViewById(R.id.tv_auth_fav);
        }
    }
}
